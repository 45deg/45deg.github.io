var e=3.56,t=.025;function n(e,t){let n=Math.hypot(e,t),r=.006*n*n,i=Math.max(0,n-2.15);return-.33+r+i*i*.11}function r(e){return Math.hypot(e[0],e[2])>3.56?[...e]:[e[0],Math.max(e[1],n(e[0],e[2])+t),e[2]]}function i(e){return e[0]*(e[4]*e[8]-e[5]*e[7])-e[1]*(e[3]*e[8]-e[5]*e[6])+e[2]*(e[3]*e[7]-e[4]*e[6])}function a(e){let t=i(e);if(Math.abs(t)<1e-10)throw Error(`Degenerate tetrahedron`);let n=1/t;return[(e[4]*e[8]-e[5]*e[7])*n,(e[2]*e[7]-e[1]*e[8])*n,(e[1]*e[5]-e[2]*e[4])*n,(e[5]*e[6]-e[3]*e[8])*n,(e[0]*e[8]-e[2]*e[6])*n,(e[2]*e[3]-e[0]*e[5])*n,(e[3]*e[7]-e[4]*e[6])*n,(e[1]*e[6]-e[0]*e[7])*n,(e[0]*e[4]-e[1]*e[3])*n]}function o(e,t){return[e[0]*t[0]+e[1]*t[3]+e[2]*t[6],e[0]*t[1]+e[1]*t[4]+e[2]*t[7],e[0]*t[2]+e[1]*t[5]+e[2]*t[8],e[3]*t[0]+e[4]*t[3]+e[5]*t[6],e[3]*t[1]+e[4]*t[4]+e[5]*t[7],e[3]*t[2]+e[4]*t[5]+e[5]*t[8],e[6]*t[0]+e[7]*t[3]+e[8]*t[6],e[6]*t[1]+e[7]*t[4]+e[8]*t[7],e[6]*t[2]+e[7]*t[5]+e[8]*t[8]]}var s=!0;function c(e){s=e}function l(){return s}var u=new WeakMap,d=(e,t,n)=>[e,t,n].sort((e,t)=>e-t).join(`,`),f=(e,t)=>e<t?`${e},${t}`:`${t},${e}`;function p(e){let t=new Map,n=e.mesh.tetrahedra,r=[[1,2,3],[0,3,2],[0,1,3],[0,2,1]];for(let e=0;e<n.length;e+=4){let i=[n[e],n[e+1],n[e+2],n[e+3]];for(let n of r){let r=d(i[n[0]],i[n[1]],i[n[2]]);t.has(r)?t.delete(r):t.set(r,{tetrahedron:e/4,indices:i})}}return t}function m(e,t=2){let n=Math.max(1,Math.floor(t)),r=l(),i=r?u.get(e):void 0;if(i?.topologyVersion===e.topologyVersion&&i.subdivisions===n)return _(i.surface,e.positions),i.surface;let a=h(e,n);return r&&u.set(e,{topologyVersion:e.topologyVersion,subdivisions:n,surface:a}),a}function h(e,t){if(e.embeddedSurface)return g(e);let n=Math.max(1,Math.floor(t)),r=e.mesh.surfaceTriangles,i=p(e),a=new Map,o=new Uint32Array(r.length/3);for(let t=0;t<r.length;t+=3){let n=r[t],i=r[t+1],s=r[t+2],c=e.surfaceFeatureMasks[n]&e.surfaceFeatureMasks[i]&e.surfaceFeatureMasks[s];if(o[t/3]=c,c!==0)for(let e of[f(n,i),f(i,s),f(s,n)])a.set(e,(a.get(e)??0)+1)}let s=[],c=[],l=[],u=[],m=[],h=[],_=[],v=[],y=[],b=new Map,x=(t,r,i,a,o)=>{let d=b.get(a);if(d!==void 0)return d;let f=u.length/3,p=[0,0,0,0];for(let e=0;e<3;e+=1){let a=i.indices.indexOf(t[e]);if(a<0)throw Error(`Render surface face is not owned by its Tet`);p[a]=r[e]/n}s.push(...i.indices),c.push(...p);let h=0,g=0,_=0;for(let t=0;t<4;t+=1){let n=i.indices[t]*3;h+=e.positions[n]*p[t],g+=e.positions[n+1]*p[t],_+=e.positions[n+2]*p[t]}return u.push(h,g,_),m.push(o),l.push(i.tetrahedron),b.set(a,f),f};for(let e=0;e<r.length;e+=3){let t=[r[e],r[e+1],r[e+2]],s=i.get(d(...t));if(!s)throw Error(`Surface triangle has no boundary Tet owner`);let c=o[e/3],l=new Map;for(let r=0;r<=n;r+=1)for(let i=0;i<=n-r;i+=1){let o=[n-r-i,r,i],u=t.map((e,t)=>[e,o[t]]).filter(([,e])=>e>0).sort(([e],[t])=>e-t).map(([e,t])=>`${e}:${t}`).join(`|`),d=[];o[0]===0&&d.push(f(t[1],t[2])),o[1]===0&&d.push(f(t[0],t[2])),o[2]===0&&d.push(f(t[0],t[1]));let p=c!==0&&d.some(e=>a.get(e)===1),m=c===0?`outer:${u}`:`cut:${e}:${u}`;l.set(`${r},${i}`,x(t,o,s,m,+!!p))}let u=c===0?h:_,p=c===0?v:y;for(let e=0;e<n;e+=1)for(let t=0;t<n-e;t+=1){let r=l.get(`${e},${t}`),i=l.get(`${e+1},${t}`),a=l.get(`${e},${t+1}`);if(u.push(r,i,a),p.push(s.tetrahedron),e+t<n-1){let n=l.get(`${e+1},${t+1}`);u.push(i,n,a),p.push(s.tetrahedron)}}}return{positions:new Float32Array(u),physicsIndices:new Uint32Array(s),weights:new Float32Array(c),vertexTetrahedra:new Uint32Array(l),triangles:new Uint32Array([...h,..._]),triangleTetrahedra:new Uint32Array([...v,...y]),outerIndexCount:h.length,cutIndexCount:_.length,wetEdge:new Float32Array(m)}}function g(e){let t=e.embeddedSurface;if(!t)throw Error(`Embedded render surface is missing`);let n=e.mesh.tetrahedra,r=e.positions,i=t.embeddingPositions??t.positions,o=[...t.positions],s=[],c=[],l=[],u=t.embeddingTopologyVersion===e.topologyVersion&&t.embeddingTetrahedra?.length===t.positions.length/3?t.embeddingTetrahedra:null,d=(e,t,o)=>{let s=e*3,c=-1/0,l=u?.[e]??0,d=[1,0,0,0],f=u?l*4:0,p=u?f+4:n.length;for(let e=f;e<p;e+=4){if(o!==void 0&&t?.[e/4]!==o)continue;let u=n.subarray(e,e+4),f=u[0]*3,p=u[1]*3,m=u[2]*3,h=u[3]*3,g=a([r[p]-r[f],r[m]-r[f],r[h]-r[f],r[p+1]-r[f+1],r[m+1]-r[f+1],r[h+1]-r[f+1],r[p+2]-r[f+2],r[m+2]-r[f+2],r[h+2]-r[f+2]]),_=i[s]-r[f],v=i[s+1]-r[f+1],y=i[s+2]-r[f+2],b=g[0]*_+g[1]*v+g[2]*y,x=g[3]*_+g[4]*v+g[5]*y,S=g[6]*_+g[7]*v+g[8]*y,C=[1-b-x-S,b,x,S],w=Math.min(...C);if(!(w<=c)&&(c=w,l=e/4,d=C,w>=-1e-5))break}return{tetrahedron:l,weights:d,minimumWeight:c}},f=Array.from({length:t.positions.length/3},(e,t)=>d(t));if(!u){let r=n.length/4,i=Array.from({length:e.positions.length/3},()=>[]);for(let e=0;e<r;e+=1)for(let t=0;t<4;t+=1)i[n[e*4+t]].push(e);let a=new Int32Array(r);a.fill(-1);let o=0;for(let e=0;e<r;e+=1){if(a[e]>=0)continue;a[e]=o;let t=[e];for(let e=0;e<t.length;e+=1){let r=t[e];for(let e=0;e<4;e+=1){let s=n[r*4+e];for(let e of i[s])a[e]>=0||(a[e]=o,t.push(e))}}o+=1}let s=new Int32Array(t.positions.length/3);for(let e=0;e<s.length;e+=1)s[e]=e;let c=e=>{let t=e;for(;s[t]!==t;)t=s[t];for(;s[e]!==e;){let n=s[e];s[e]=t,e=n}return t},l=(e,t)=>{let n=c(e),r=c(t);n!==r&&(s[r]=n)};for(let e=0;e<t.triangles.length;e+=3)l(t.triangles[e],t.triangles[e+1]),l(t.triangles[e],t.triangles[e+2]);let u=new Map;for(let e=0;e<f.length;e+=1){let t=c(e),n=a[f[e].tetrahedron],r=u.get(t)??new Map,i=r.get(n)??{count:0,minimumWeightSum:0};i.count+=1,i.minimumWeightSum+=f[e].minimumWeight,r.set(n,i),u.set(t,r)}let p=new Map;for(let[e,t]of u){let n=-1,r={count:-1,minimumWeightSum:-1/0};for(let[e,i]of t)(i.count>r.count||i.count===r.count&&i.minimumWeightSum>r.minimumWeightSum)&&(n=e,r=i);p.set(e,n)}for(let e=0;e<f.length;e+=1){let t=p.get(c(e));t!==void 0&&a[f[e].tetrahedron]!==t&&(f[e]=d(e,a,t))}}for(let e=0;e<f.length;e+=1){let t=f[e],r=t.tetrahedron*4;l[e]=t.tetrahedron;for(let e=0;e<4;e+=1)s.push(n[r+e]),c.push(t.weights[e])}let p=[],m=[],h=[];for(let e=0;e<t.triangles.length/3;e+=1){let n=e*3,r=(t.triangleFeatureMasks?.[e]??0)===0?p:m;r.push(t.triangles[n],t.triangles[n+1],t.triangles[n+2]),r===p&&h.push(l[t.triangles[n]])}let g=[];for(let e=0;e<t.triangles.length/3;e+=1)(t.triangleFeatureMasks?.[e]??0)!==0&&g.push(l[t.triangles[e*3]]);let _=Array(t.positions.length/3).fill(0);for(let e of m)_[e]=.72;return{positions:new Float32Array(o),physicsIndices:new Uint32Array(s),weights:new Float32Array(c),vertexTetrahedra:new Uint32Array(l),triangles:new Uint32Array([...p,...m]),triangleTetrahedra:new Uint32Array([...h,...g]),outerIndexCount:p.length,cutIndexCount:m.length,wetEdge:new Float32Array(_)}}function _(e,t){for(let n=0;n<e.positions.length/3;n+=1){let r=0,i=0,a=0;for(let o=0;o<4;o+=1){let s=e.physicsIndices[n*4+o]*3,c=e.weights[n*4+o];r+=t[s]*c,i+=t[s+1]*c,a+=t[s+2]*c}e.positions[n*3]=r,e.positions[n*3+1]=i,e.positions[n*3+2]=a}}var v=[[0,1],[0,2],[0,3],[1,2],[1,3],[2,3]],y=[[1,2,3],[0,3,2],[0,1,3],[0,2,1]];function b(e,t){let n=t*3;return[e[n],e[n+1],e[n+2]]}function x(e,t){let n=t*9;return[[e.triangles[n],e.triangles[n+1],e.triangles[n+2]],[e.triangles[n+3],e.triangles[n+4],e.triangles[n+5]],[e.triangles[n+6],e.triangles[n+7],e.triangles[n+8]]]}function S(e,t=0){let n=[1/0,1/0,1/0],r=[-1/0,-1/0,-1/0];for(let i of e)for(let e=0;e<3;e+=1)n[e]=Math.min(n[e],i[e]-t),r[e]=Math.max(r[e],i[e]+t);return{minimum:n,maximum:r}}function C(e,t){for(let n=0;n<3;n+=1)if(e.maximum[n]<t.minimum[n]||t.maximum[n]<e.minimum[n])return!1;return!0}function w(e,t){return[e[0]-t[0],e[1]-t[1],e[2]-t[2]]}function T(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function E(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function D(e,t,n){let r=w(t,e),i=w(n[1],n[0]),a=w(n[2],n[0]),o=E(r,a),s=T(i,o);if(Math.abs(s)<1e-10)return!1;let c=1/s,l=w(e,n[0]),u=T(l,o)*c;if(u<-1e-7||u>1.0000001)return!1;let d=E(l,i),f=T(r,d)*c;if(f<-1e-7||u+f>1.0000001)return!1;let p=T(a,d)*c;return p>=-1e-7&&p<=1.0000001}function O(e,t,n,r,i){let a=E(w(n,t),w(r,t));return T(a,w(e,t))*T(a,w(i,t))>=-1e-9}function k(e,t){return O(e,t[1],t[2],t[3],t[0])&&O(e,t[0],t[3],t[2],t[1])&&O(e,t[0],t[1],t[3],t[2])&&O(e,t[0],t[2],t[1],t[3])}function A(e,t){if(e.some(e=>k(e,t)))return!0;for(let[n,r]of v)if(D(t[n],t[r],e))return!0;for(let n=0;n<3;n+=1){let r=e[n],i=e[(n+1)%3];for(let[e,n,a]of y)if(D(r,i,[t[e],t[n],t[a]]))return!0}return!1}function j(e,t,n){let r=n.triangles.length/9,i=Array.from({length:r},(e,t)=>x(n,t)),a=i.map(e=>S(e,n.width)),o=[];for(let r=0;r<e.tetrahedra.length/4;r+=1){let s=r*4,c=[b(t,e.tetrahedra[s]),b(t,e.tetrahedra[s+1]),b(t,e.tetrahedra[s+2]),b(t,e.tetrahedra[s+3])],l=S(c,n.width);i.some((e,t)=>C(l,a[t])&&A(e,c))&&o.push(r)}return new Uint32Array(o)}var M=Math.floor(Math.sqrt(2**53-1)),ee=Math.floor(Math.cbrt(2**53-1));function N(e,t,n){let r=Math.min(e,t),i=Math.max(e,t);return n<=M?r*n+i:`${r},${i}`}function P(e,t,n,r){let i=e,a=t,o=n;return i>a&&([i,a]=[a,i]),a>o&&([a,o]=[o,a]),i>a&&([i,a]=[a,i]),r<=ee?(i*r+a)*r+o:`${i},${a},${o}`}function F(e,t,n){let r=new Uint32Array(t);L(e,r);let i=te(r,e.length/3);return{restPositions:e,tetrahedra:r,surfaceTriangles:i.triangles,surfaceVertices:i.vertices,surfaceEdges:i.edges,surfaceVertexNeighbours:i.vertexNeighbours,particleRadius:n}}function I(e,t,n,r,i){let a=t*3,o=n*3,s=r*3,c=i*3;return[e[o]-e[a],e[s]-e[a],e[c]-e[a],e[o+1]-e[a+1],e[s+1]-e[a+1],e[c+1]-e[a+1],e[o+2]-e[a+2],e[s+2]-e[a+2],e[c+2]-e[a+2]]}function L(e,t){for(let n=0;n<t.length;n+=4){let r=t[n],a=t[n+1],o=t[n+2],s=t[n+3];i(I(e,r,a,o,s))<0&&(t[n+1]=o,t[n+2]=a)}}function te(e,t){let n=new Map,r=(e,r,i)=>{let a=P(e,r,i,t),o=n.get(a);o?o.count+=1:n.set(a,{count:1,oriented:[e,r,i]})};for(let t=0;t<e.length;t+=4){let n=e[t],i=e[t+1],a=e[t+2],o=e[t+3];r(i,a,o),r(n,o,a),r(n,i,o),r(n,a,i)}let i=[],a=new Set;for(let e of n.values())if(e.count===1){i.push(...e.oriented);for(let t of e.oriented)a.add(t)}let o=[],s=new Set,c=Array.from({length:t},()=>new Set),l=(e,n)=>{let r=Math.min(e,n),i=Math.max(e,n),a=N(r,i,t);s.has(a)||(s.add(a),o.push(r,i)),c[e].add(n),c[n].add(e)};for(let e=0;e<i.length;e+=3){let t=i[e],n=i[e+1],r=i[e+2];l(t,n),l(n,r),l(r,t)}return{triangles:new Uint32Array(i),vertices:new Uint32Array(a),edges:new Uint32Array(o),vertexNeighbours:c.map(e=>new Uint32Array(e))}}function R(e,t,n,r=3){let i=r+1,a=[],o=(e,t,n)=>e+i*(t+i*n),s=.42;for(let i=0;i<=r;i+=1)for(let o=0;o<=r;o+=1)for(let c=0;c<=r;c+=1){let l=c/r*2-1,u=o/r*2-1,d=i/r*2-1,f=l*Math.sqrt(Math.max(0,1-u*u/2-d*d/2+u*u*d*d/3)),p=u*Math.sqrt(Math.max(0,1-d*d/2-l*l/2+d*d*l*l/3)),m=d*Math.sqrt(Math.max(0,1-l*l/2-u*u/2+l*l*u*u/3));a.push(e*(l+(f-l)*s)/2,t*(u+(p-u)*s)/2,n*(d+(m-d)*s)/2)}let c=[],l=[[0,1,3,7],[0,1,5,7],[0,2,3,7],[0,2,6,7],[0,4,5,7],[0,4,6,7]];for(let e=0;e<r;e+=1)for(let t=0;t<r;t+=1)for(let n=0;n<r;n+=1){let r=[o(n,t,e),o(n+1,t,e),o(n,t+1,e),o(n+1,t+1,e),o(n,t,e+1),o(n+1,t,e+1),o(n,t+1,e+1),o(n+1,t+1,e+1)];for(let e of l)c.push(...e.map(e=>r[e]))}return F(new Float32Array(a),new Uint32Array(c),Math.min(e,t,n)/r*.42)}function z(e,t,n=4,r=16){let i=n+1,a=(e,t,n)=>e+i*(n+i*t),o=e/2,s=t/2-o,c=Math.max(1,Math.floor((r-1)/2)),l=Math.min(c,Math.max(2,Math.round(r*e/t))),u=r-l*2,d=[];for(let e=0;e<=r;e+=1){let r=e<=l?-t/2+o*e/l:e>=l+u?s+o*(e-l-u)/l:-s+s*2*(e-l)/u,i=Math.max(0,Math.abs(r)-s),a=Math.max(.12,Math.sqrt(Math.max(0,1-(i/o)**2)));for(let e=0;e<=n;e+=1)for(let t=0;t<=n;t+=1){let i=t/n*2-1,s=e/n*2-1,c=i*Math.sqrt(1-s*s/2),l=s*Math.sqrt(1-i*i/2);d.push(o*a*c,r,o*a*l)}}let f=[],p=[[0,1,3,7],[0,1,5,7],[0,2,3,7],[0,2,6,7],[0,4,5,7],[0,4,6,7]];for(let e=0;e<r;e+=1)for(let t=0;t<n;t+=1)for(let r=0;r<n;r+=1){let n=[a(r,e,t),a(r+1,e,t),a(r,e,t+1),a(r+1,e,t+1),a(r,e+1,t),a(r+1,e+1,t),a(r,e+1,t+1),a(r+1,e+1,t+1)];for(let e of p)f.push(...e.map(e=>n[e]))}return F(new Float32Array(d),new Uint32Array(f),e/n*.42)}function B(e,t,n=5,r=5){let i=n+1,a=(e,t,n)=>e+i*(n+i*t),o=e/2,s=[];for(let e=0;e<=r;e+=1){let i=e/r,a=.9+.1*Math.sin(Math.min(1,i/.22)*Math.PI/2),c=1-.2*i*i;for(let e=0;e<=n;e+=1)for(let r=0;r<=n;r+=1){let l=r/n*2-1,u=e/n*2-1,d=l*Math.sqrt(1-u*u/2),f=u*Math.sqrt(1-l*l/2),p=Math.min(1,Math.hypot(d,f)),m=Math.atan2(f,d),h=.3+.7*Math.sin(Math.PI*i)**.7,g=1+Math.cos(m*8)*.115*p**1.35*h,_=i**6,v=Math.exp(-(((p-.58)/.25)**2))*.045,y=(1-p)**2*.12,b=p**4*.035,x=t*_*(v-y-b);s.push(o*a*c*g*d,t*(i-.5)+x,o*a*c*g*f)}}let c=[],l=[[0,1,3,7],[0,1,5,7],[0,2,3,7],[0,2,6,7],[0,4,5,7],[0,4,6,7]];for(let e=0;e<r;e+=1)for(let t=0;t<n;t+=1)for(let r=0;r<n;r+=1){let n=[a(r,e,t),a(r+1,e,t),a(r,e,t+1),a(r+1,e,t+1),a(r,e+1,t),a(r+1,e+1,t),a(r,e+1,t+1),a(r+1,e+1,t+1)];for(let e of l)c.push(...e.map(e=>n[e]))}return F(new Float32Array(s),new Uint32Array(c),e/n*.36)}function V(e,t,n,r=8,i=9,a=7){let o=1/0,s=1/0,c=1/0,l=-1/0,u=-1/0,d=-1/0;for(let t=0;t<e.length;t+=3)o=Math.min(o,e[t]),s=Math.min(s,e[t+1]),c=Math.min(c,e[t+2]),l=Math.max(l,e[t]),u=Math.max(u,e[t+1]),d=Math.max(d,e[t+2]);let f=(l-o)/r,p=(u-s)/i,m=(d-c)/a,h=new Uint8Array(r*i*a),g=(e,t,n)=>e+r*(t+i*n),_=(n,r,i)=>{let a=0;for(let o=0;o<t.length;o+=3){let s=t[o]*3,c=t[o+1]*3,l=t[o+2]*3,u=e[s+1],d=e[s+2],f=e[c+1],p=e[c+2],m=e[l+1],h=e[l+2],g=(p-h)*(u-m)+(m-f)*(d-h);if(Math.abs(g)<1e-10)continue;let _=((p-h)*(r-m)+(m-f)*(i-h))/g,v=((h-d)*(r-m)+(u-m)*(i-h))/g,y=1-_-v;_<-1e-7||v<-1e-7||y<-1e-7||_*e[s]+v*e[c]+y*e[l]>n+1e-7&&(a+=1)}return a};for(let e=0;e<a;e+=1)for(let t=0;t<i;t+=1)for(let n=0;n<r;n+=1)_(o+(n+.5)*f,s+(t+.5)*p,c+(e+.5)*m)%2==1&&(h[g(n,t,e)]=1);for(let t=0;t<e.length;t+=3){let n=Math.min(r-1,Math.max(0,Math.floor((e[t]-o)/f))),l=Math.min(i-1,Math.max(0,Math.floor((e[t+1]-s)/p))),u=Math.min(a-1,Math.max(0,Math.floor((e[t+2]-c)/m)));h[g(n,l,u)]=1}let v=e=>{let[t,n,r,i]=e;h[t]!==0&&h[i]!==0&&h[n]===0&&h[r]===0?(h[n]=1,h[r]=1):h[n]!==0&&h[r]!==0&&h[t]===0&&h[i]===0&&(h[t]=1,h[i]=1)};for(let e=0;e<2;e+=1){for(let e=0;e<a;e+=1)for(let t=0;t<i-1;t+=1)for(let n=0;n<r-1;n+=1)v([g(n,t,e),g(n+1,t,e),g(n,t+1,e),g(n+1,t+1,e)]);for(let e=0;e<i;e+=1)for(let t=0;t<a-1;t+=1)for(let n=0;n<r-1;n+=1)v([g(n,e,t),g(n+1,e,t),g(n,e,t+1),g(n+1,e,t+1)]);for(let e=0;e<r;e+=1)for(let t=0;t<a-1;t+=1)for(let n=0;n<i-1;n+=1)v([g(e,n,t),g(e,n+1,t),g(e,n,t+1),g(e,n+1,t+1)])}let y=new Map,b=[],x=(e,t,r)=>{let i=`${e},${t},${r}`,a=y.get(i);if(a!==void 0)return a;let l=b.length/3;return y.set(i,l),b.push((o+e*f)*n,(s+t*p-.5)*n,(c+r*m)*n),l},S=[[0,1,3,7],[0,1,5,7],[0,2,3,7],[0,2,6,7],[0,4,5,7],[0,4,6,7]],C=[];for(let e=0;e<a;e+=1)for(let t=0;t<i;t+=1)for(let n=0;n<r;n+=1){if(h[g(n,t,e)]===0)continue;let r=[x(n,t,e),x(n+1,t,e),x(n,t+1,e),x(n+1,t+1,e),x(n,t,e+1),x(n+1,t,e+1),x(n,t+1,e+1),x(n+1,t+1,e+1)];for(let e of S)C.push(...e.map(e=>r[e]))}if(C.length===0)throw Error(`PLY voxelization produced an empty volume`);return F(new Float32Array(b),new Uint32Array(C),Math.min(f,p,m)*n*.36)}var H=[[0,1],[0,2],[0,3],[1,2],[1,3],[2,3]],U=[[1,2,3],[0,3,2],[0,1,3],[0,2,1]];function W(e,t){let n=t*3;return[e[n],e[n+1],e[n+2]]}function ne(e,t){return Math.hypot(e[0]-t[0],e[1]-t[1],e[2]-t[2])}function re(e,t,n){let r=[t[0]-e[0],t[1]-e[1],t[2]-e[2]],i=[n[0]-e[0],n[1]-e[1],n[2]-e[2]];return .5*Math.hypot(r[1]*i[2]-r[2]*i[1],r[2]*i[0]-r[0]*i[2],r[0]*i[1]-r[1]*i[0])}function G(e,t,n){return e[0]*(t[1]*n[2]-t[2]*n[1])-t[0]*(e[1]*n[2]-e[2]*n[1])+n[0]*(e[1]*t[2]-e[2]*t[1])}function ie(e){let t=e[0],n=e.slice(1).map(e=>[e[0]-t[0],e[1]-t[1],e[2]-t[2]]),r=G(n[0],n[1],n[2]);if(Math.abs(r)<1e-15)return 1/0;let i=n.map(e=>.5*(e[0]**2+e[1]**2+e[2]**2)),a=[n[0][0],n[0][1],n[0][2]],o=[n[1][0],n[1][1],n[1][2]],s=[n[2][0],n[2][1],n[2][2]],c=((e,t,n)=>e[0]*(t[1]*n[2]-t[2]*n[1])-e[1]*(t[0]*n[2]-t[2]*n[0])+e[2]*(t[0]*n[1]-t[1]*n[0]))(a,o,s),l=(i[0]*(o[1]*s[2]-o[2]*s[1])-a[1]*(i[1]*s[2]-o[2]*i[2])+a[2]*(i[1]*s[1]-o[1]*i[2]))/c,u=(a[0]*(i[1]*s[2]-o[2]*i[2])-i[0]*(o[0]*s[2]-o[2]*s[0])+a[2]*(o[0]*i[2]-i[1]*s[0]))/c,d=(a[0]*(o[1]*i[2]-i[1]*s[1])-a[1]*(o[0]*i[2]-i[1]*s[0])+i[0]*(o[0]*s[1]-o[1]*s[0]))/c;return Math.hypot(l,u,d)}function ae(e,t){let n=t.map(t=>W(e,t)),r=n[1].map((e,t)=>e-n[0][t]),i=n[2].map((e,t)=>e-n[0][t]),a=n[3].map((e,t)=>e-n[0][t]),o=Math.abs(G(r,i,a))/6,s=1/0;for(let[e,t]of H)s=Math.min(s,ne(n[e],n[t]));let c=0;for(let[e,t,r]of U)c+=re(n[e],n[t],n[r]);let l=c>0?3*o/c:0,u=ie(n),d=Number.isFinite(u)&&u>0?Math.max(0,Math.min(1,3*l/u)):0;return{restVolume:o,shortestEdge:s,radiusRatio:d}}function oe(e){let t=new Int32Array(e.restPositions.length/3);t.fill(-1);let n=e=>{let n=e;for(;t[n]!==n;)n=t[n];for(;t[e]!==e;){let r=t[e];t[e]=n,e=r}return n},r=(e,r)=>{let i=n(e),a=n(r);i!==a&&(t[a]=i)};for(let n of e.tetrahedra)t[n]=n;for(let t=0;t<e.tetrahedra.length;t+=4){let n=e.tetrahedra[t];for(let i=1;i<4;i+=1)r(n,e.tetrahedra[t+i])}let i=new Set;for(let e=0;e<t.length;e+=1)t[e]>=0&&i.add(n(e));return i.size}function se(e){let t=new Map,n=e.restPositions.length/3;for(let r=0;r<e.surfaceTriangles.length;r+=3){let i=[e.surfaceTriangles[r],e.surfaceTriangles[r+1],e.surfaceTriangles[r+2]];for(let e=0;e<3;e+=1){let r=i[e],a=i[(e+1)%3],o=N(r,a,n);t.set(o,(t.get(o)??0)+1)}}let r=0;for(let e of t.values())e!==2&&(r+=1);return r}function ce(e,t=1e3){let n=0,r=1/0,i=1/0,a=1/0,o=0,s=!0,c=[0,0,0],l=new Uint8Array(e.restPositions.length/3);for(let t=0;t<e.tetrahedra.length;t+=4){let u=[e.tetrahedra[t],e.tetrahedra[t+1],e.tetrahedra[t+2],e.tetrahedra[t+3]],d=ae(e.restPositions,u);n+=d.restVolume,r=Math.min(r,d.restVolume),i=Math.min(i,d.shortestEdge),a=Math.min(a,d.radiusRatio),(d.restVolume<=1e-12||d.radiusRatio<=1e-8)&&(o+=1),s&&=Number.isFinite(d.restVolume+d.shortestEdge+d.radiusRatio);for(let t of u){l[t]=1;let n=t*3;for(let t=0;t<3;t+=1)c[t]+=e.restPositions[n+t]*d.restVolume/4}}let u=0;for(let e of l)e===0&&(u+=1);let d=n>0?c.map(e=>e/n):[0,0,0];for(let t of e.restPositions)s&&=Number.isFinite(t);return{restVolume:n,mass:n*t,centerOfMass:d,minimumRestVolume:r===1/0?0:r,minimumEdgeLength:i===1/0?0:i,minimumRadiusRatio:a===1/0?0:a,degenerateTetrahedra:o,isolatedVertices:u,connectedComponents:oe(e),nonManifoldSurfaceEdges:se(e),finite:s}}function le(e,t){return Math.abs(e-t)/Math.max(Math.abs(e),Math.abs(t),1e-12)}var K=[[1,2,3],[0,3,2],[0,1,3],[0,2,1]],ue=[[0,1],[0,2],[0,3],[1,2],[1,3],[2,3]];function de(e,t,n,r,i,a){let o=Math.hypot(r[0],r[1],r[2]);if(o<1e-8)return null;let s=[r[0]/o,r[1]/o,r[2]/o],c=[n[0]+s[0]*i,n[1]+s[1]*i,n[2]+s[2]*i],l=e.restPositions.length/3,u=a?new Uint8Array(l):null;if(a&&u){for(let t=0;t<e.tetrahedra.length;t+=4)if(a[t/4]!==0)for(let n=0;n<4;n+=1)u[e.tetrahedra[t+n]]=1}let d=new Float64Array(l),f=new Int8Array(l),p=Math.max(e.particleRadius*5e-4,1e-8);for(let e=0;e<l;e+=1){if(u&&!u[e])continue;let n=e*3,r=(t[n]-c[0])*s[0]+(t[n+1]-c[1])*s[1]+(t[n+2]-c[2])*s[2];d[e]=r,r>p?f[e]=1:r<-p&&(f[e]=-1)}let m=2e-4;for(let t=0;t<e.tetrahedra.length;t+=4)if(!(a&&a[t/4]===0))for(let[n,r]of ue){let i=e.tetrahedra[t+n],a=e.tetrahedra[t+r];if(f[i]*f[a]>=0)continue;let o=Math.abs(d[i])/(Math.abs(d[i])+Math.abs(d[a]));o<m?f[i]=0:1-o<m&&(f[a]=0)}let h=!1,g=!1;for(let e=0;e<l;e+=1)u&&!u[e]||(h||=f[e]>0,g||=f[e]<0);if(!h||!g)return null;let _=Array.from(e.restPositions),v=[],y=[],b=[],x=new Map,S=new Map,C=new Map,w=new Map,T=0,E=e=>{if(e<l)return new Map([[e,1]]);let t=x.get(e);if(!t)throw Error(`Missing interpolation for cut vertex ${e}`);return t},D=t=>{let n=0;for(let e of t.values())n+=e;let r=new Map;for(let[e,i]of t){let t=i/n;Math.abs(t)>1e-10&&r.set(e,t)}let i=[...r].sort(([e],[t])=>e-t),a=_.length/3,o=0,s=0,c=0;for(let[t,n]of i){let r=t*3;o+=e.restPositions[r]*n,s+=e.restPositions[r+1]*n,c+=e.restPositions[r+2]*n}return _.push(o,s,c),x.set(a,r),b.push({indices:new Uint32Array(i.map(([e])=>e)),weights:new Float32Array(i.map(([,e])=>e))}),a},O=(e,t)=>{if(f[e]!==0||t<0)return e;let n=S.get(e);if(n!==void 0)return n;let r=D(new Map([[e,1]]));return S.set(e,r),w.set(e,r),r},k=(e,t,n)=>{if(f[e]===0)return O(e,n);if(f[t]===0)return O(t,n);let r=N(Math.min(e,t),Math.max(e,t),l),i=C.get(r);if(!i){let n=d[e]-d[t],a=d[e]/n,o=new Map([[e,1-a],[t,a]]);i={negative:D(o),positive:D(o)},C.set(r,i),w.set(i.negative,i.positive)}return n<0?i.negative:i.positive},A=e=>{let t=[];for(let n of e)t.at(-1)!==n&&t.push(n);return t.length>1&&t[0]===t.at(-1)&&t.pop(),t},j=(e,t)=>{let n=[];for(let r=0;r<e.length;r+=1){let i=e[r],a=e[(r+1)%e.length];f[i]*t>=0&&n.push(O(i,t)),f[i]*f[a]<0&&n.push(k(i,a,t))}return A(n)},M=e=>{let n=E(e),r=0,i=0,a=0;for(let[e,o]of n){let n=e*3;r+=t[n]*o,i+=t[n+1]*o,a+=t[n+2]*o}return[r,i,a]},ee=e=>{let t=[...new Set(e)];if(t.length<3)return t;let n=[0,0,0];for(let e of t){let t=M(e);n[0]+=t[0],n[1]+=t[1],n[2]+=t[2]}n[0]/=t.length,n[1]/=t.length,n[2]/=t.length;let r=Math.abs(s[0])<.8?[1,0,0]:[0,1,0],i=[s[1]*r[2]-s[2]*r[1],s[2]*r[0]-s[0]*r[2],s[0]*r[1]-s[1]*r[0]],a=Math.hypot(...i);i=i.map(e=>e/a);let o=[s[1]*i[2]-s[2]*i[1],s[2]*i[0]-s[0]*i[2],s[0]*i[1]-s[1]*i[0]];return t.sort((e,t)=>{let r=M(e),a=M(t),s=e=>{let t=(e[0]-n[0])*i[0]+(e[1]-n[1])*i[1]+(e[2]-n[2])*i[2],r=(e[0]-n[0])*o[0]+(e[1]-n[1])*o[1]+(e[2]-n[2])*o[2];return Math.atan2(r,t)};return s(r)-s(a)})},I=e=>{if(e.length<3)return[];let t=e.indexOf(Math.min(...e)),n=[...e.slice(t),...e.slice(0,t)],r=[];for(let e=1;e<n.length-1;e+=1)r.push([n[0],n[e],n[e+1]]);return r},L=(e,t,n,r)=>{let i=e*3,a=t*3,o=n*3,s=r*3,c=[_[a]-_[i],_[a+1]-_[i+1],_[a+2]-_[i+2]],l=[_[o]-_[i],_[o+1]-_[i+1],_[o+2]-_[i+2]],u=[_[s]-_[i],_[s+1]-_[i+1],_[s+2]-_[i+2]];return c[0]*(l[1]*u[2]-l[2]*u[1])-c[1]*(l[0]*u[2]-l[2]*u[0])+c[2]*(l[0]*u[1]-l[1]*u[0])},te=(e,t)=>{v.push(t[0],t[1],t[2],t[3]),y.push(e)},R=(e,t,n)=>{let r=[];for(let n of K){let i=n.map(t=>e[t]),a=j(i,t);a.length>=3&&r.push(a)}let i=[];for(let n of e)f[n]===0&&i.push(O(n,t));for(let[n,r]of ue){let a=e[n],o=e[r];f[a]*f[o]<0&&i.push(k(a,o,t))}let a=ee(i);a.length>=3&&r.push(a);let o=[...new Set(r.flat())],s=Math.min(...o);for(let e of r)if(!e.includes(s))for(let t of I(e))Math.abs(L(s,...t))>1e-12&&te(n,[s,...t])};for(let t=0;t<e.tetrahedra.length;t+=4){let n=t/4,r=[e.tetrahedra[t],e.tetrahedra[t+1],e.tetrahedra[t+2],e.tetrahedra[t+3]];if(a&&a[n]===0){te(n,r);continue}let i=r.some(e=>f[e]>0),o=r.some(e=>f[e]<0);if(i&&o){T+=1,R(r,-1,n),R(r,1,n);continue}let s=i?1:-1;te(n,r.map(e=>O(e,s)))}if(T===0&&S.size===0)return null;let z=F(new Float32Array(_),new Uint32Array(v),e.particleRadius),B=z.restPositions.length/3,V=new Map;for(let e=0;e<z.surfaceTriangles.length;e+=3){let t=[z.surfaceTriangles[e],z.surfaceTriangles[e+1],z.surfaceTriangles[e+2]];V.set(P(...t,B),t)}let H=[];for(let e of V.values()){let t=e.map(e=>w.get(e));if(t.some(e=>e===void 0))continue;let n=V.get(P(t[0],t[1],t[2],B));n&&H.push(...e,...n)}let U=[...w].flatMap(([e,t])=>[e,t]);return{mesh:z,tetrahedronParents:new Uint32Array(y),vertexInterpolations:b,cutSurface:{point:c,normal:s,vertexPairs:new Uint32Array(U),trianglePairs:new Uint32Array(H)},diagnostics:ce(z),planeOffset:i}}function fe(e,t,n,r,i){let a=ce(e),o=Math.max(e.particleRadius*.002,2e-6),s=[0,o,-o,o*2,-o*2],c=de(e,t,n,r,0,i);if(!c||c.diagnostics.connectedComponents<=a.connectedComponents)return null;let l=null,u=-1/0;for(let d of s){let s=d===0?c:de(e,t,n,r,d,i);if(!s)continue;let f=s.diagnostics,p=le(a.restVolume,f.restVolume),m=le(a.mass,f.mass),h=Math.hypot(a.centerOfMass[0]-f.centerOfMass[0],a.centerOfMass[1]-f.centerOfMass[1],a.centerOfMass[2]-f.centerOfMass[2])/Math.max(e.particleRadius,1e-8),g=Math.max(a.restVolume*1e-10,2e-11);if(!(f.finite&&f.degenerateTetrahedra===0&&f.minimumRestVolume>=g&&f.minimumRadiusRatio>=2e-4&&f.nonManifoldSurfaceEdges===0&&f.isolatedVertices===0&&p<=1e-5&&m<=1e-5&&h<=1e-5&&s.cutSurface.trianglePairs.length>0))continue;if(d===0&&f.minimumRadiusRatio>=.01)return s;let _=f.minimumRadiusRatio-Math.abs(d)/o*1e-6;_>u&&(l=s,u=_)}return l}function pe(e,t,n,r,i){let a=r=>{let i=r*3,a=[e.positions[i],e.positions[i+1],e.positions[i+2]];return{key:`v${r}`,position:a,embeddingPosition:e.embeddingPositions?[e.embeddingPositions[i],e.embeddingPositions[i+1],e.embeddingPositions[i+2]]:a,distance:(a[0]-t[0])*n[0]+(a[1]-t[1])*n[1]+(a[2]-t[2])*n[2]}},o=(e,t)=>{let n=e.distance-t.distance,r=Math.abs(n)>1e-9?e.distance/n:.5,i=[e.key,t.key].sort();return{key:`e${i[0]}|${i[1]}`,position:[e.position[0]+(t.position[0]-e.position[0])*r,e.position[1]+(t.position[1]-e.position[1])*r,e.position[2]+(t.position[2]-e.position[2])*r],embeddingPosition:[e.embeddingPosition[0]+(t.embeddingPosition[0]-e.embeddingPosition[0])*r,e.embeddingPosition[1]+(t.embeddingPosition[1]-e.embeddingPosition[1])*r,e.embeddingPosition[2]+(t.embeddingPosition[2]-e.embeddingPosition[2])*r],distance:0}},s=(e,t)=>{let n=[];for(let r=0;r<e.length;r+=1){let i=e[r],a=e[(r+1)%e.length],s=i.distance*t>=-1e-6,c=a.distance*t>=-1e-6;s&&c?n.push(a):s?n.push(o(i,a)):c&&n.push(o(i,a),a)}return n.filter((e,t)=>e.key!==n[t-1]?.key)},c=[],l=[],u=[],d=[],f=[],p=new Map,m=(e,t)=>{let i=`${t}:${e.key}`,a=p.get(i);if(a!==void 0)return a;let o=c.length/3;p.set(i,o),c.push(...e.position);let s=Math.abs(e.distance)<=1e-6?r*.04:0;return l.push(e.embeddingPosition[0]+n[0]*t*s,e.embeddingPosition[1]+n[1]*t*s,e.embeddingPosition[2]+n[2]*t*s),f.push(t),o},h=(e,t,n,r)=>{e===t||t===n||n===e||(u.push(e,t,n),d.push(r))},g=(e,t,n)=>{if(e.length<3)return;let r=e.map(e=>m(e,t));for(let e=1;e<r.length-1;e+=1)h(r[0],r[e],r[e+1],n)};for(let t=0;t<e.triangles.length;t+=3){let n=[a(e.triangles[t]),a(e.triangles[t+1]),a(e.triangles[t+2])],r=e.triangleFeatureMasks?.[t/3]??0;g(s(n,-1),-1,r),g(s(n,1),1,r)}let _=(e,t)=>e<t?`${e},${t}`:`${t},${e}`,v=new Map;for(let e=0;e<u.length;e+=3){let t=[u[e],u[e+1],u[e+2]];for(let e=0;e<3;e+=1){let n=t[e],r=t[(e+1)%3],i=_(n,r),a=v.get(i);a?a.count+=1:v.set(i,{count:1,first:n,second:r})}}let y=[...v.values()].filter(e=>e.count===1),b=new Map;for(let e of y){let t=b.get(e.first)??[];t.push(e.second),b.set(e.first,t);let n=b.get(e.second)??[];n.push(e.first),b.set(e.second,n)}let x=new Set,S=[];for(let e of y){let t=e.first,n=e.second;if(x.has(_(t,n)))continue;let r=[t],i=t,a=n;x.add(_(t,n));for(let e=0;e<=y.length&&a!==t;e+=1){r.push(a);let e=(b.get(a)??[]).find(e=>e!==i&&!x.has(_(a,e)));if(e===void 0)break;x.add(_(a,e)),i=a,a=e}a===t&&r.length>=3&&S.push(r)}let C=e=>{let[t,r,i]=e.position,a=n.map(Math.abs);return a[0]>=a[1]&&a[0]>=a[2]?[r,i]:a[1]>=a[2]?[t,i]:[t,r]},w=e=>{let t=0;for(let n=0;n<e.length;n+=1){let r=C(e[n]),i=C(e[(n+1)%e.length]);t+=r[0]*i[1]-i[0]*r[1]}return t*.5},T=(e,t,n,r)=>{let i=(e,t,n)=>(t[0]-e[0])*(n[1]-e[1])-(t[1]-e[1])*(n[0]-e[0]),a=i(t,n,e),o=i(n,r,e),s=i(r,t,e);return a>=-1e-10&&o>=-1e-10&&s>=-1e-10},E=e=>{let t=e.map(C),n=Array.from({length:e.length},(e,t)=>t);w(e)<0&&n.reverse();let r=[];for(;n.length>3;){let e=!1;for(let i=0;i<n.length;i+=1){let a=n[(i+n.length-1)%n.length],o=n[i],s=n[(i+1)%n.length],c=t[a],l=t[o],u=t[s];if((l[0]-c[0])*(u[1]-l[1])-(l[1]-c[1])*(u[0]-l[0])>1e-10&&!n.some(e=>e!==a&&e!==o&&e!==s&&T(t[e],c,l,u))){r.push(a,o,s),n.splice(i,1),e=!0;break}}if(!e)break}return n.length===3&&r.push(...n),r},D=(e,t,r)=>{let i=[t.position[0]-e.position[0],t.position[1]-e.position[1],t.position[2]-e.position[2]],a=[r.position[0]-e.position[0],r.position[1]-e.position[1],r.position[2]-e.position[2]];return(i[1]*a[2]-i[2]*a[1])*n[0]+(i[2]*a[0]-i[0]*a[2])*n[1]+(i[0]*a[1]-i[1]*a[0])*n[2]},O=1<<Math.min(i,30);for(let e of S){let t=e.map(e=>({key:`cap${e}`,position:[c[e*3],c[e*3+1],c[e*3+2]],embeddingPosition:[l[e*3],l[e*3+1],l[e*3+2]],distance:0})),n=E(t),r=f[e[0]];for(let i=0;i<n.length;i+=3){let a=n[i],o=n[i+1],s=n[i+2],c=r===-1?1:-1;D(t[a],t[o],t[s])*c<0&&([o,s]=[s,o]),h(e[a],e[o],e[s],O)}}return{positions:new Float32Array(c),triangles:new Uint32Array(u),embeddingPositions:new Float32Array(l),triangleFeatureMasks:new Uint32Array(d)}}var me=[1,0,0,0,1,0,0,0,1];function he(e,t){let n=Math.min(1,Math.max(0,e)),r=Math.min(1,Math.max(0,t)),i=.84-n*.46;return{equilibriumWeight:i,branches:[{weight:1-i,relaxationTime:1.8*.1**r*Math.exp(.46*Math.log(.22)+.34*Math.log(.9)+.2*Math.log(3.4))}]}}function ge(e,t){return t.map(t=>{let n=new Float32Array(e*9);for(let t=0;t<e;t+=1)n.set(me,t*9);return{...t,viscousDeformations:n}})}function _e(e,t){return e.map(e=>{let n=new Float32Array(t.length*9);for(let r=0;r<t.length;r+=1){let i=t[r]*9;n.set(e.viscousDeformations.subarray(i,i+9),r*9)}return{weight:e.weight,relaxationTime:e.relaxationTime,viscousDeformations:n}})}var ve=[1,0,0,0,1,0,0,0,1];function ye(e){let t=new Float32Array(e*9);for(let n=0;n<e;n+=1)t.set(ve,n*9);return t}function be(e,t){let n=new Float32Array(t.length*9);for(let r=0;r<t.length;r+=1){let i=t[r]*9;n.set(e.subarray(i,i+9),r*9)}return n}function xe(e,t){let n=t*9;return[...e.subarray(n,n+9)]}function q(e,t){let n=new Float32Array(t.length);for(let r=0;r<t.length;r+=1)n[r]=e[t[r]];return n}function Se(e,t,n){let r=o(e,a(t)),i=[r[0]-1,(r[1]+r[3])*.5,(r[2]+r[6])*.5,(r[3]+r[1])*.5,r[4]-1,(r[5]+r[7])*.5,(r[6]+r[2])*.5,(r[7]+r[5])*.5,r[8]-1],s=0;for(let e of i)s+=e*e;let c=Math.sqrt(s),l=[1,.37,.19];for(let e=0;e<8;e+=1){let e=[(i[0]+c)*l[0]+i[1]*l[1]+i[2]*l[2],i[3]*l[0]+(i[4]+c)*l[1]+i[5]*l[2],i[6]*l[0]+i[7]*l[1]+(i[8]+c)*l[2]],t=Math.hypot(...e);if(t<1e-9)break;l=e.map(e=>e/t)}let u=[i[0]*l[0]+i[1]*l[1]+i[2]*l[2],i[3]*l[0]+i[4]*l[1]+i[5]*l[2],i[6]*l[0]+i[7]*l[1]+i[8]*l[2]],d=l[0]*u[0]+l[1]*u[1]+l[2]*u[2];return{maximumPrincipalStress:Math.max(0,2*n*d),direction:l}}function Ce(e,t,n,r,i,a){if(t<=n)return e;let o=t/Math.max(n,1)-1,s=Math.max(.08,r/Math.max(n*i,1e-6));return Math.min(1,e+a*o**1.35/s)}var we=2400,Te=5,Ee=1.65,De=class{shape;mesh;positions;previousPositions;velocities;inverseMasses;constraints;material;maxwellBranches;plasticDeformations;cohesiveDamage;selfFractureEnabled;topologyVersion=0;cutCount=0;selfCollisionEnabled=!1;activeCutSurfaceContacts=[];topologyCollisionVertexMask;topologyCollisionTriangleMask;surfaceFeatureMasks;embeddedSurface;selfFractureCount=0;constructor(e){this.shape=e.shape??`jelly`;let t=e.size*(.78+e.stiffness*.2),n=e.size*1.5;this.mesh=e.shape===`tube`?z(e.size,e.size*4.25):e.shape===`procedural`?B(e.size*1.55,e.size):e.shape===`bunny`&&e.renderSource?V(e.renderSource.positions,e.renderSource.triangles,n):R(e.size,t,e.size,3),this.positions=new Float32Array(this.mesh.restPositions.length),this.previousPositions=new Float32Array(this.mesh.restPositions.length),this.velocities=new Float32Array(this.mesh.restPositions.length),this.inverseMasses=new Float32Array(this.mesh.restPositions.length/3),this.topologyCollisionVertexMask=new Uint8Array(this.mesh.restPositions.length/3),this.topologyCollisionTriangleMask=new Uint8Array(this.mesh.surfaceTriangles.length/3),this.surfaceFeatureMasks=new Uint32Array(this.mesh.restPositions.length/3);let r=e.rotationY??0,i=e.rotationZ??0,a=Math.cos(r),o=Math.sin(r),s=Math.cos(i),c=Math.sin(i),l=(t,n,r)=>{let i=t*s-n*c,l=t*c+n*s;return[e.x+i*a+r*o,e.y+l,e.z-i*o+r*a]};for(let e=0;e<this.mesh.restPositions.length;e+=3){let t=this.mesh.restPositions[e],n=this.mesh.restPositions[e+1],r=this.mesh.restPositions[e+2],i=l(t,n,r);this.positions.set(i,e)}if(this.mesh.restPositions.set(this.positions),this.previousPositions.set(this.positions),e.shape===`bunny`&&e.renderSource){let t=new Float32Array(e.renderSource.positions.length);for(let r=0;r<t.length;r+=3){let i=l(e.renderSource.positions[r]*n,(e.renderSource.positions[r+1]-.5)*n,e.renderSource.positions[r+2]*n);t.set(i,r)}this.embeddedSurface={positions:t,triangles:e.renderSource.triangles}}else this.embeddedSurface=null;let u=e.jiggle??.58,d=e.recoverySpeed??.5,f=Math.min(e.sag??.15,.7),p=he(u,d);this.material=Oe(e.stiffness,u,d,f,p.equilibriumWeight),this.constraints=this.createConstraints(),this.maxwellBranches=ge(this.constraints.length,p.branches),this.plasticDeformations=ye(this.constraints.length),this.cohesiveDamage=new Float32Array(this.constraints.length),this.selfFractureEnabled=e.selfFracture??!1,this.assignMasses()}createConstraints(){let e=[];for(let t=0;t<this.mesh.tetrahedra.length;t+=4){let n=[this.mesh.tetrahedra[t],this.mesh.tetrahedra[t+1],this.mesh.tetrahedra[t+2],this.mesh.tetrahedra[t+3]],r=ke(this.mesh.restPositions,n),o=i(r);e.push({indices:n,restInverse:a(r),restVolume:Math.abs(o)/6})}return e}assignMasses(){let e=new Float32Array(this.inverseMasses.length);for(let t of this.constraints){let n=1e3*t.restVolume/4;for(let r of t.indices)e[r]+=n}for(let t=0;t<e.length;t+=1)this.inverseMasses[t]=e[t]>0?1/e[t]:0}enableTopologyCollisions(e){this.selfCollisionEnabled=!0,this.activeCutSurfaceContacts.push(e),this.rebuildTopologyCollisionPatch()}get cutSurfaceContact(){return this.activeCutSurfaceContacts.at(-1)??null}advanceCutSurfaceContacts(e){for(let t=this.activeCutSurfaceContacts.length-1;t>=0;--t){let n=this.activeCutSurfaceContacts[t];n.projectionPassesRemaining=Math.max(0,n.projectionPassesRemaining-e),n.projectionPassesRemaining===0&&this.activeCutSurfaceContacts.splice(t,1)}}rebuildTopologyCollisionPatch(){let e=this.positions.length/3,t=new Uint8Array(e);for(let n=0;n<e;n+=1)this.surfaceFeatureMasks[n]!==0&&(t[n]=1);this.topologyCollisionVertexMask=new Uint8Array(e),this.topologyCollisionVertexMask.set(t);for(let n=0;n<e;n+=1)if(t[n]!==0)for(let e of this.mesh.surfaceVertexNeighbours[n])this.topologyCollisionVertexMask[e]=1;let n=this.mesh.surfaceTriangles;this.topologyCollisionTriangleMask=new Uint8Array(n.length/3);for(let e=0;e<n.length;e+=3){let r=n[e],i=n[e+1],a=n[e+2];t[r]===0&&t[i]===0&&t[a]===0||(this.topologyCollisionTriangleMask[e/3]=1,this.topologyCollisionVertexMask[r]=1,this.topologyCollisionVertexMask[i]=1,this.topologyCollisionVertexMask[a]=1)}}cut(e,t){if(this.cutCount>=Te)return!1;let n=fe(this.mesh,this.positions,e,t);return!n||n.mesh.tetrahedra.length/4>we?!1:(this.applyCutTopology(n),this.enableTopologyCollisions({normal:n.cutSurface.normal,vertexPairs:n.cutSurface.vertexPairs,trianglePairs:n.cutSurface.trianglePairs,targetSeparation:this.mesh.particleRadius*.035,projectionPassesRemaining:240}),!0)}tetrahedronComponent(e){let t=this.mesh.tetrahedra.length/4,n=new Uint8Array(t);if(e<0||e>=t)return n;let r=Array.from({length:this.positions.length/3},()=>[]);for(let e=0;e<t;e+=1)for(let t=0;t<4;t+=1)r[this.mesh.tetrahedra[e*4+t]].push(e);let i=[e];n[e]=1;for(let e=0;e<i.length;e+=1){let t=i[e];for(let e=0;e<4;e+=1){let a=this.mesh.tetrahedra[t*4+e];for(let e of r[a])n[e]===0&&(n[e]=1,i.push(e))}}return n}componentVertices(e){let t=new Uint8Array(this.positions.length/3);for(let n=0;n<e.length;n+=1)if(e[n]!==0)for(let e=0;e<4;e+=1)t[this.mesh.tetrahedra[n*4+e]]=1;let n=[];for(let e=0;e<t.length;e+=1)t[e]!==0&&n.push(e);return new Uint32Array(n)}cutWithBlade(e,t=we,n){let r={intersectionMilliseconds:0,remeshingMilliseconds:0},i=Math.min(t,we);if(this.cutCount>=Te||this.constraints.length>=i)return{cut:!1,intersectedTetrahedra:0,reactionForce:0,estimatedWork:0,timings:r};let a=n===void 0?void 0:this.tetrahedronComponent(n),o=performance.now(),s=new Uint32Array([...j(this.mesh,this.positions,e)].filter(e=>!a||a[e]!==0));r.intersectionMilliseconds=performance.now()-o;let c=this.material.cohesiveStrength*e.width*this.mesh.particleRadius,l=c*e.pathLength;if(s.length===0)return{cut:!1,intersectedTetrahedra:s.length,reactionForce:c,estimatedWork:l,timings:r};let u=performance.now(),d=fe(this.mesh,this.positions,e.point,e.normal,a);return r.remeshingMilliseconds=performance.now()-u,!d||d.mesh.tetrahedra.length/4>i?{cut:!1,intersectedTetrahedra:s.length,reactionForce:c,estimatedWork:l,timings:r}:(this.applyCutTopology(d),this.enableTopologyCollisions({normal:d.cutSurface.normal,vertexPairs:d.cutSurface.vertexPairs,trianglePairs:d.cutSurface.trianglePairs,targetSeparation:Math.min(e.width*.15,this.mesh.particleRadius*.018),projectionPassesRemaining:240}),{cut:!0,intersectedTetrahedra:s.length,reactionForce:c,estimatedWork:l,timings:r})}trySelfFracture(e){if(!this.selfFractureEnabled||this.selfFractureCount>=2)return!1;let t=this.material.youngModulus/(2*(1+this.material.poissonRatio)),n=-1,r=[1,0,0];for(let i=0;i<this.constraints.length;i+=1){let a=this.constraints[i],s=Se(o(ke(this.positions,a.indices),a.restInverse),xe(this.plasticDeformations,i),t);if(this.cohesiveDamage[i]=Ce(this.cohesiveDamage[i],s.maximumPrincipalStress,this.material.cohesiveStrength,this.material.fractureEnergy,Math.cbrt(a.restVolume),e),this.cohesiveDamage[i]>=1){n=i,r=s.direction;break}}if(n<0)return!1;let i=this.constraints[n].indices,a=[0,0,0];for(let e of i)for(let t=0;t<3;t+=1)a[t]+=this.positions[e*3+t]/4;let s=this.cut(a,r);return s&&(this.selfFractureCount+=1,this.cohesiveDamage.fill(0)),s}applyCutTopology(e){let t=this.maxwellBranches,n=this.plasticDeformations,r=this.cohesiveDamage,i=this.positions.length/3,a=this.surfaceFeatureMasks;this.embeddedSurface&&=pe(this.embeddedSurface,e.cutSurface.point,e.cutSurface.normal,this.mesh.particleRadius,this.cutCount);let o=t=>{let n=new Float32Array(e.mesh.restPositions.length);n.set(t);let r=t.length/3;for(let i=0;i<e.vertexInterpolations.length;i+=1){let a=e.vertexInterpolations[i],o=r+i;for(let e=0;e<3;e+=1){let r=0;for(let n=0;n<a.indices.length;n+=1)r+=t[a.indices[n]*3+e]*a.weights[n];n[o*3+e]=r}}return n};this.positions=o(this.positions),this.previousPositions=o(this.previousPositions),this.velocities=o(this.velocities),this.mesh=e.mesh,this.constraints=this.createConstraints(),this.maxwellBranches=_e(t,e.tetrahedronParents),this.plasticDeformations=be(n,e.tetrahedronParents),this.cohesiveDamage=q(r,e.tetrahedronParents),this.inverseMasses=new Float32Array(this.positions.length/3),this.topologyCollisionVertexMask=new Uint8Array(this.positions.length/3),this.topologyCollisionTriangleMask=new Uint8Array(this.mesh.surfaceTriangles.length/3),this.surfaceFeatureMasks=new Uint32Array(this.positions.length/3),this.surfaceFeatureMasks.set(a);for(let t=0;t<e.vertexInterpolations.length;t+=1){let n=e.vertexInterpolations[t],r=4294967295;for(let e of n.indices)r&=a[e];this.surfaceFeatureMasks[i+t]=r>>>0}let s=1<<Math.min(this.cutCount,30);for(let t of e.cutSurface.trianglePairs)this.surfaceFeatureMasks[t]|=s;this.assignMasses(),this.topologyVersion+=1,this.cutCount+=1}};function Oe(e,t,n,r,i){return{stiffness:e,youngModulus:6e3*30**e,poissonRatio:.46+e*.025,velocityDamping:.32+(1-t)*1.5+(1-e)*.22,jiggle:t,recoverySpeed:n,equilibriumShearWeight:i,sag:r,yieldStress:2e3+18e4*(1-r)**3,plasticViscosity:1e4+14e4*(1-r)**2,cohesiveStrength:3e3+18e3*e,fractureEnergy:18+92*e}}function ke(e,t){let n=t[0]*3,r=t[1]*3,i=t[2]*3,a=t[3]*3;return[e[r]-e[n],e[i]-e[n],e[a]-e[n],e[r+1]-e[n+1],e[i+1]-e[n+1],e[a+1]-e[n+1],e[r+2]-e[n+2],e[i+2]-e[n+2],e[a+2]-e[n+2]]}function Ae(e,t){let n=e.length/4,r=Array.from({length:t},()=>new Set),i=new Uint16Array(n),a=0;for(let t=0;t<n;t+=1){let n=new Set,o=t*4;for(let t=0;t<4;t+=1)for(let i of r[e[o+t]])n.add(i);let s=0;for(;n.has(s);)s+=1;if(s>65535)throw Error(`Tetrahedron coloring exceeded Uint16 range`);i[t]=s,a=Math.max(a,s+1);for(let t=0;t<4;t+=1)r[e[o+t]].add(s)}let o=new Uint32Array(a);for(let e of i)o[e]+=1;let s=new Uint32Array(a+1);for(let e=0;e<a;e+=1)s[e+1]=s[e]+o[e];let c=new Uint32Array(s),l=new Uint32Array(n);for(let e=0;e<n;e+=1){let t=i[e];l[c[t]]=e,c[t]+=1}return{orderedTetrahedra:l,colorOffsets:s,tetrahedronColors:i}}var je=new WeakMap;function Me(e,t){let n=t[0]*3,r=t[1]*3,i=t[2]*3,a=t[3]*3;return[e[r]-e[n],e[i]-e[n],e[a]-e[n],e[r+1]-e[n+1],e[i+1]-e[n+1],e[a+1]-e[n+1],e[r+2]-e[n+2],e[i+2]-e[n+2],e[a+2]-e[n+2]]}function Ne(e){let t=e.positions.length/3,n=new Uint32Array(t);for(let e=0;e<t;e+=1)n[e]=e;let r=e=>{let t=e;for(;n[t]!==t;)t=n[t];for(;n[e]!==e;){let r=n[e];n[e]=t,e=r}return t},i=(e,t)=>{let i=r(e),a=r(t);i!==a&&(n[a]=i)};for(let t=0;t<e.mesh.tetrahedra.length;t+=4){let n=e.mesh.tetrahedra[t];i(n,e.mesh.tetrahedra[t+1]),i(n,e.mesh.tetrahedra[t+2]),i(n,e.mesh.tetrahedra[t+3])}let a=new Map,o=new Uint32Array(t);for(let e=0;e<t;e+=1){let t=r(e),n=a.get(t);n===void 0&&(n=a.size,a.set(t,n)),o[e]=n}return{indices:o,count:a.size}}function Pe(e,t){let n=l(),r=n?je.get(e):void 0;if(r?.topologyVersion===e.topologyVersion)return _(r.renderSurface,e.positions),r;let o=performance.now(),s=m(e);t&&(t.renderSurfaceMilliseconds+=performance.now()-o);let c=e.mesh.tetrahedra.length/4,u=Array(c),d=new Float32Array(c);for(let t=0;t<c;t+=1){let n=t*4,r=e.mesh.tetrahedra.subarray(n,n+4),o=Me(e.mesh.restPositions,r);u[t]=a(o),d[t]=Math.abs(i(o))/6}let f=Array.from({length:e.positions.length/3},(t,n)=>{let r=new Set([n]);for(let t of e.mesh.surfaceVertexNeighbours[n]){r.add(t);for(let n of e.mesh.surfaceVertexNeighbours[t])r.add(n)}return new Uint32Array([...r].sort((e,t)=>e-t))}),p={topologyVersion:e.topologyVersion,components:Ne(e),renderSurface:s,restInverses:u,restVolumes:d,surfaceTwoRingExclusions:f,coloring:Ae(e.mesh.tetrahedra,e.positions.length/3)};return n&&je.set(e,p),p}function Fe(e,t){let n=0,r=0,i=0,a=0,o=0,s=1/0;for(let t of e)n+=t.positions.length/3,r+=t.mesh.tetrahedra.length/4,i+=t.mesh.surfaceVertices.length,a+=t.mesh.surfaceTriangles.length/3,o+=t.mesh.surfaceEdges.length/2,s=Math.min(s,t.mesh.particleRadius);let c=new Float32Array(n*4),l=new Float32Array(n*4),u=new Uint32Array(n),d=new Uint32Array(n),f=new Uint32Array(n),p=new Uint32Array(n),m=Array.from({length:n},()=>[]),h=new Uint32Array(i*2),g=new Uint32Array(a*4),_=new Uint32Array(o*4),v=[],y=new Uint32Array(r*4),b=[],x=new Float32Array(r),S=new Float32Array(r*16),C=new Float32Array(r*36),w=new Float32Array(r*12),T=new Uint32Array(r),E=new Uint32Array(e.length+1),D=new Uint32Array(e.length+1),O=0,k=0,A=0,j=0,M=0,ee=0,N=e.map(e=>Pe(e,t));for(let t=0;t<e.length;t+=1){let n=e[t],r=N[t],i=r.components;E[t]=O,D[t]=k;let a=n.positions.length/3;for(let e=0;e<a;e+=1){let a=e*3,o=(O+e)*4;c[o]=n.positions[a],c[o+1]=n.positions[a+1],c[o+2]=n.positions[a+2],c[o+3]=n.inverseMasses[e],l[o]=n.velocities[a],l[o+1]=n.velocities[a+1],l[o+2]=n.velocities[a+2],l[o+3]=n.material.velocityDamping;let s=O+e;u[s]=t,d[s]=ee+i.indices[e],p[s]=n.selfCollisionEnabled?n.topologyCollisionVertexMask[e]:0,p[s]!==0&&(m[s]=Array.from(r.surfaceTwoRingExclusions[e],e=>O+e))}for(let e of n.mesh.surfaceVertices){let n=O+e;f[n]=t+1,h[A*2]=n,h[A*2+1]=t,A+=1}for(let e of n.activeCutSurfaceContacts)for(let t=0;t<e.vertexPairs.length;t+=2)v.push({negative:O+e.vertexPairs[t],positive:O+e.vertexPairs[t+1],normal:e.normal,targetSeparation:e.targetSeparation,maximumProjectionPasses:e.projectionPassesRemaining});for(let e=0;e<n.mesh.surfaceTriangles.length;e+=3){let t=j*4;g[t]=O+n.mesh.surfaceTriangles[e],g[t+1]=O+n.mesh.surfaceTriangles[e+1],g[t+2]=O+n.mesh.surfaceTriangles[e+2];let r=n.selfCollisionEnabled&&n.topologyCollisionTriangleMask[e/3]!==0?2147483648:0;g[t+3]=(d[g[t]]|r)>>>0,j+=1}for(let e=0;e<n.mesh.surfaceEdges.length;e+=2){let r=M*4;_[r]=O+n.mesh.surfaceEdges[e],_[r+1]=O+n.mesh.surfaceEdges[e+1],_[r+2]=t,_[r+3]=d[_[r]],M+=1}for(let e=0;e<n.mesh.tetrahedra.length;e+=4){let i=[n.mesh.tetrahedra[e],n.mesh.tetrahedra[e+1],n.mesh.tetrahedra[e+2],n.mesh.tetrahedra[e+3]],a=k+e/4;T[a]=t;for(let e=0;e<4;e+=1)y[a*4+e]=O+i[e];b[a]=r.restInverses[e/4],x[a]=r.restVolumes[e/4];let o=a*16;S[o]=n.material.youngModulus,S[o+1]=n.material.poissonRatio,S[o+2]=n.material.equilibriumShearWeight,S[o+3]=Math.min(n.maxwellBranches.length,3),S[o+12]=n.material.yieldStress,S[o+13]=n.material.plasticViscosity,S[o+14]=Math.max(.08,1-n.cohesiveDamage[e/4]);for(let t=0;t<3;t+=1){let r=n.maxwellBranches[t];if(!r)continue;S[o+4+t]=r.weight,S[o+8+t]=r.relaxationTime;let i=e/4*9,s=a*36+t*12;C.set(r.viscousDeformations.subarray(i,i+3),s),C.set(r.viscousDeformations.subarray(i+3,i+6),s+4),C.set(r.viscousDeformations.subarray(i+6,i+9),s+8)}let s=e/4*9,c=a*12;w.set(n.plasticDeformations.subarray(s,s+3),c),w.set(n.plasticDeformations.subarray(s+3,s+6),c+4),w.set(n.plasticDeformations.subarray(s+6,s+9),c+8)}O+=a,k+=n.mesh.tetrahedra.length/4,ee+=i.count}E[e.length]=O,D[e.length]=k;let P=N.map(e=>e.renderSurface),F=P.reduce((e,t)=>e+t.positions.length/3,0),I=P.reduce((e,t)=>e+t.triangles.length/3,0),L=new Float32Array(F*4),te=new Uint32Array(F*4),R=new Float32Array(F*4),z=new Uint32Array(I*4),B=new Uint32Array(e.length+1),V=new Uint32Array(e.length+1),H=0,U=0;for(let t=0;t<e.length;t+=1){let e=P[t],n=E[t];B[t]=H,V[t]=U;for(let t=0;t<e.positions.length/3;t+=1){let r=(H+t)*4,i=t*3;L[r]=e.positions[i],L[r+1]=e.positions[i+1],L[r+2]=e.positions[i+2],L[r+3]=1;for(let i=0;i<4;i+=1)te[r+i]=n+e.physicsIndices[t*4+i],R[r+i]=e.weights[t*4+i]}for(let t=0;t<e.triangles.length/3;t+=1){let n=(U+t)*4,r=t*3;z[n]=H+e.triangles[r],z[n+1]=H+e.triangles[r+1],z[n+2]=H+e.triangles[r+2]}H+=e.positions.length/3,U+=e.triangles.length/3}B[e.length]=H,V[e.length]=U;let W=new Uint32Array(F+1);for(let e=0;e<I;e+=1){let t=e*4;W[z[t]+1]+=1,W[z[t+1]+1]+=1,W[z[t+2]+1]+=1}for(let e=0;e<F;e+=1)W[e+1]+=W[e];let ne=new Uint32Array(I*3),re=W.slice(0,F);for(let e=0;e<I;e+=1){let t=e*4;for(let n=0;n<3;n+=1){let r=z[t+n];ne[re[r]++]=e}}let G=new Uint32Array(n+1);for(let e=0;e<a;e+=1){let t=e*4;G[g[t]+1]+=1,G[g[t+1]+1]+=1,G[g[t+2]+1]+=1}for(let e=0;e<n;e+=1)G[e+1]+=G[e];let ie=new Uint32Array(a*3),ae=G.slice(0,n);for(let e=0;e<a;e+=1){let t=e*4;for(let n=0;n<3;n+=1){let r=g[t+n];ie[ae[r]]=e,ae[r]+=1}}let oe=new Uint32Array(n+1),se=0;for(let e=0;e<n;e+=1)oe[e]=se,se+=m[e].length;oe[n]=se;let ce=new Uint32Array(se),le=0;for(let e of m)ce.set(e,le),le+=e.length;let K=N.reduce((e,t)=>Math.max(e,t.coloring.colorOffsets.length-1),0),ue=new Uint32Array(K),de=new Uint16Array(r);for(let t=0;t<e.length;t+=1){let e=N[t].coloring,n=D[t];de.set(e.tetrahedronColors,n);for(let t of e.tetrahedronColors)ue[t]+=1}let fe=new Uint32Array(K+1);for(let e=0;e<K;e+=1)fe[e+1]=fe[e]+ue[e];let pe=fe.slice(0,K),me=new Uint32Array(r);for(let t=0;t<e.length;t+=1){let e=N[t].coloring,n=D[t];for(let t=0;t<e.colorOffsets.length-1;t+=1)for(let r=e.colorOffsets[t];r<e.colorOffsets[t+1];r+=1)me[pe[t]]=n+e.orderedTetrahedra[r],pe[t]+=1}let he={orderedTetrahedra:me,colorOffsets:fe,tetrahedronColors:de},ge=Array.from({length:e.length},()=>Array.from({length:K},()=>[]));for(let e=0;e<K;e+=1)for(let t=he.colorOffsets[e];t<he.colorOffsets[e+1];t+=1)ge[T[he.orderedTetrahedra[t]]][e].push(t);let _e=new Uint32Array(e.length*(K+1)),ve=new Uint32Array(r),ye=0;for(let t=0;t<e.length;t+=1){let e=t*(K+1);for(let n=0;n<K;n+=1)_e[e+n]=ye,ve.set(ge[t][n],ye),ye+=ge[t][n].length;_e[e+K]=ye}let be=new ArrayBuffer(r*80),xe=new Uint32Array(be),q=new Float32Array(be),Se=new Float32Array(r*16),Ce=new Float32Array(r*36),we=new Float32Array(r*12),Te=new Uint32Array(r),Ee=new Uint32Array(r);for(let e=0;e<r;e+=1){let t=he.orderedTetrahedra[e],n=T[t];Te[e]=n,Ee[e]=t-D[n];let r=e*20;for(let e=0;e<4;e+=1)xe[r+e]=y[t*4+e];let i=b[t];q.set(i.slice(0,3),r+4),q.set(i.slice(3,6),r+8),q.set(i.slice(6,9),r+12),q[r+16]=x[t],q[r+17]=n,Se.set(S.subarray(t*16,t*16+16),e*16),Ce.set(C.subarray(t*36,t*36+36),e*36),we.set(w.subarray(t*12,t*12+12),e*12)}let De=new ArrayBuffer(v.length*32),Oe=new Uint32Array(De),ke=new Float32Array(De);for(let e=0;e<v.length;e+=1){let t=v[e],n=e*8;Oe[n]=t.negative,Oe[n+1]=t.positive,Oe[n+2]=t.maximumProjectionPasses,ke[n+4]=t.normal[0],ke[n+5]=t.normal[1],ke[n+6]=t.normal[2],ke[n+7]=t.targetSeparation}return{positions:c,velocities:l,vertexBodyIndices:u,surfaceComponentIndices:d,surfaceFlags:f,surfaceSelfContactFlags:p,selfContactExclusionOffsets:oe,selfContactExclusions:ce,surfaceVertices:h,surfaceTriangles:g,surfaceEdges:_,incidentSurfaceTriangleOffsets:G,incidentSurfaceTriangles:ie,renderPositions:L,renderPhysicsIndices:te,renderWeights:R,renderTriangles:z,renderIncidentTriangleOffsets:W,renderIncidentTriangles:ne,cutSurfacePairs:De,cutSurfacePairCount:v.length,tetrahedra:be,materials:Se,maxwellStates:Ce,plasticStates:we,coloring:he,elasticityClusterOffsets:_e,elasticityClusterTetrahedra:ve,bodyVertexOffsets:E,bodyRenderVertexOffsets:B,bodyRenderTriangleOffsets:V,bodyTetrahedronOffsets:D,tetrahedronBodyIndices:Te,tetrahedronLocalIndices:Ee,vertexCount:n,tetrahedronCount:r,surfaceVertexCount:i,surfaceTriangleCount:a,surfaceEdgeCount:o,renderVertexCount:F,renderTriangleCount:I,bodyCount:e.length,contactCellSize:Number.isFinite(s)?s*1.5:1,contactThickness:Number.isFinite(s)?s*.12:.01}}function Ie(e,t,n){for(let r=0;r<e.length;r+=1){let i=e[r],a=t.bodyVertexOffsets[r],o=t.bodyVertexOffsets[r+1];for(let e=a;e<o;e+=1){let t=(e-a)*3,r=e*4;i.positions[t]=n.positions[r],i.positions[t+1]=n.positions[r+1],i.positions[t+2]=n.positions[r+2],i.previousPositions[t]=n.previousPositions[r],i.previousPositions[t+1]=n.previousPositions[r+1],i.previousPositions[t+2]=n.previousPositions[r+2],i.velocities[t]=n.velocities[r],i.velocities[t+1]=n.velocities[r+1],i.velocities[t+2]=n.velocities[r+2]}}for(let r=0;r<t.tetrahedronCount;r+=1){let i=e[t.tetrahedronBodyIndices[r]],a=t.tetrahedronLocalIndices[r];for(let e=0;e<i.maxwellBranches.length&&e<3;e+=1){let t=r*36+e*12,o=a*9,s=i.maxwellBranches[e].viscousDeformations;s[o]=n.maxwellStates[t],s[o+1]=n.maxwellStates[t+1],s[o+2]=n.maxwellStates[t+2],s[o+3]=n.maxwellStates[t+4],s[o+4]=n.maxwellStates[t+5],s[o+5]=n.maxwellStates[t+6],s[o+6]=n.maxwellStates[t+8],s[o+7]=n.maxwellStates[t+9],s[o+8]=n.maxwellStates[t+10]}let o=r*12,s=a*9;i.plasticDeformations[s]=n.plasticStates[o],i.plasticDeformations[s+1]=n.plasticStates[o+1],i.plasticDeformations[s+2]=n.plasticStates[o+2],i.plasticDeformations[s+3]=n.plasticStates[o+4],i.plasticDeformations[s+4]=n.plasticStates[o+5],i.plasticDeformations[s+5]=n.plasticStates[o+6],i.plasticDeformations[s+6]=n.plasticStates[o+8],i.plasticDeformations[s+7]=n.plasticStates[o+9],i.plasticDeformations[s+8]=n.plasticStates[o+10]}}var Le=new WeakMap,Re=8,ze=128*1024*1024,Be=8*1024*1024,Ve=new WeakMap,He=!0;function Ue(e){He=e}function We(e,t){return Math.ceil(e/t)*t}function Ge(e){let t=Math.min(Math.ceil(e*(e<=Be?2:1.25)),ze);return Math.max(4,We(Math.max(e,t),256))}function Ke(e){let t=Le.get(e);return t||(t={available:[]},Le.set(e,t)),t}function qe(e,t,n){let r=Math.max(4,We(t.byteLength,4));if(!l()||!He){let i=e.createBuffer({size:r,usage:n,mappedAtCreation:!0});return t.byteLength>0&&new Uint8Array(i.getMappedRange()).set(new Uint8Array(t.buffer,t.byteOffset,t.byteLength)),i.unmap(),i}let i=Ke(e),a=-1,o=1/0;for(let e=0;e<i.available.length;e+=1){let t=i.available[e];t.usage===n&&t.size>=r&&t.size<o&&(a=e,o=t.size)}let s;if(a>=0){let[n]=i.available.splice(a,1);s=n.buffer;let r=Ve.get(s);r&&(r.released=!1),t.byteLength>0&&e.queue.writeBuffer(s,0,t)}else{let i=Ge(r);s=e.createBuffer({size:i,usage:n|Re,mappedAtCreation:!0}),t.byteLength>0&&new Uint8Array(s.getMappedRange()).set(new Uint8Array(t.buffer,t.byteOffset,t.byteLength)),s.unmap(),Ve.set(s,{device:e,size:i,usage:n,released:!1})}return s}function J(e){let t=Ve.get(e);if(!t){e.destroy();return}if(t.released)return;t.released=!0;let n=Ke(t.device);if(n.available.push({buffer:e,size:t.size,usage:t.usage}),n.available.length>128){n.available.sort((e,t)=>t.size-e.size);for(let e of n.available.splice(128))Ve.delete(e.buffer),e.buffer.destroy()}}function Je(e){let t=Le.get(e);if(t){for(let e of t.available)Ve.delete(e.buffer),e.buffer.destroy();t.available.length=0,Le.delete(e)}}var Ye=new WeakMap,Xe=new WeakMap,Ze=1;function Qe(e){let t=Xe.get(e);return t===void 0&&(t=Ze,Ze+=1,Xe.set(e,t)),t}function $e(e){let t=Ye.get(e);return t||(t={modules:new Map,pipelines:new Map,bindGroups:new Map},Ye.set(e,t)),t}async function et(e,t,n){let r=e.createShaderModule({code:n}),i=(await r.getCompilationInfo()).messages.filter(e=>e.type===`error`);if(i.length>0)throw Error(`${t}: ${i.map(e=>`${e.lineNum}:${e.linePos} ${e.message}`).join(` | `)}`);return r}function tt(e,t,n){let r=$e(e),i=r.modules.get(n);return i||(i=et(e,t,n),r.modules.set(n,i)),i}function Y(e,t,n,r){if(!l())return et(e,t,n).then(t=>e.createComputePipelineAsync({layout:`auto`,compute:{module:t,entryPoint:r}}));let i=$e(e),a=`${n}\u0000${r}`,o=i.pipelines.get(a);return o||(o=tt(e,t,n).then(t=>e.createComputePipelineAsync({layout:`auto`,compute:{module:t,entryPoint:r}})),i.pipelines.set(a,o)),o}function X(e,t){let{cacheKey:n,...r}=t;if(!l())return e.createBindGroup(r);let i=$e(e),a=t.layout,o=[Qe(n??a),...t.entries.map(e=>{let{binding:t,resource:n}=e;return`${t}:${Qe(n.buffer)}:${n.offset??0}:${n.size??0}`})].join(`|`),s=i.bindGroups.get(o);return s||(s=e.createBindGroup(r),i.bindGroups.set(o,s)),s}var nt={COPY_SRC:4,COPY_DST:8,MAP_READ:1,STORAGE:128,UNIFORM:64},rt=1,it=`
struct Params {
  releaseY: f32,
  vertexCount: u32,
  bodyCount: u32,
...
`;function at(e,t,n){return qe(e,t,n)}var ot=class e{device;vertexCount;bodyCount;parametersBuffer;flagsBuffer;readbackBuffer;clearPipeline;classifyPipeline;clearGroup;classifyGroup;constructor(e,t,n,r,i,a,o,s,c,l){this.device=e,this.vertexCount=t,this.bodyCount=n,this.parametersBuffer=r,this.flagsBuffer=i,this.readbackBuffer=a,this.clearPipeline=o,this.classifyPipeline=s,this.clearGroup=c,this.classifyGroup=l}static async create(t,n,r,i,a){let[o,s]=await Promise.all([Y(t,`body-release WGSL`,it,`clearFlags`),Y(t,`body-release WGSL`,it,`classifyVertices`)]),c=at(t,new Uint8Array(16),nt.UNIFORM|nt.COPY_DST),l=at(t,new Uint32Array(a),nt.STORAGE|nt.COPY_SRC),u=t.createBuffer({size:Math.max(4,a*4),usage:nt.MAP_READ|nt.COPY_DST}),d=[{binding:0,resource:{buffer:n}},{binding:1,resource:{buffer:r}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:c}}],f=X(t,{cacheKey:o,layout:o.getBindGroupLayout(0),entries:[{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:c}}]}),p=X(t,{cacheKey:s,layout:s.getBindGroupLayout(0),entries:d});return new e(t,i,a,c,l,u,o,s,f,p)}async readFlags(e){let t=new ArrayBuffer(16);new Float32Array(t)[0]=e,new Uint32Array(t)[1]=this.vertexCount,new Uint32Array(t)[2]=this.bodyCount,this.device.queue.writeBuffer(this.parametersBuffer,0,t);let n=this.device.createCommandEncoder(),r=n.beginComputePass();r.setPipeline(this.clearPipeline),r.setBindGroup(0,this.clearGroup),r.dispatchWorkgroups(Math.ceil(this.bodyCount/64)),r.end(),r=n.beginComputePass(),r.setPipeline(this.classifyPipeline),r.setBindGroup(0,this.classifyGroup),r.dispatchWorkgroups(Math.ceil(this.vertexCount/64)),r.end(),n.copyBufferToBuffer(this.flagsBuffer,0,this.readbackBuffer,0,this.bodyCount*4),this.device.queue.submit([n.finish()]),await this.readbackBuffer.mapAsync(rt);let i=new Uint32Array(this.readbackBuffer.getMappedRange()).slice();return this.readbackBuffer.unmap(),i}destroy(){J(this.parametersBuffer),J(this.flagsBuffer),this.readbackBuffer.destroy()}},Z={COPY_SRC:4,COPY_DST:8,MAP_READ:1,STORAGE:128,UNIFORM:64},st=`
...
`;function _t(e,t,n){return qe(e,t,n)}function vt(e,t,n){let r=[e[0]-t[0],e[1]-t[1],e[2]-t[2]],i=Math.hypot(...r);if(i<=1e-8)return[0,0,0];let a=Math.min(.9,n/i);return[r[0]*a,r[1]*a,r[2]*a]}function yt(e,t){let n=Math.hypot(...e),r=n>t?t/n:1;return[e[0]*r,e[1]*r,e[2]*r]}var bt=class e{device;vertexCount;maximumFrameTranslation;maximumReleaseSpeed;recordsBuffer;parametersBuffer;beginFramePipeline;projectPipeline;beginFrameGroup;projectGroup;state=`inactive`;bodyIndex=0;target=[0,0,0];projectedTarget=[0,0,0];grabOrigin=[0,0,0];releaseVelocity=[0,0,0];releaseAfterInitialize=!1;constructor(e,t,n,r,i,a,o,s,c,l){this.device=e,this.vertexCount=t,this.maximumFrameTranslation=n,this.maximumReleaseSpeed=r,this.recordsBuffer=i,this.parametersBuffer=a,this.beginFramePipeline=o,this.projectPipeline=s,this.beginFrameGroup=c,this.projectGroup=l}static async create(t,n,r,i,a,o,s,c){let l=_t(t,new Float32Array(n*4),ht.STORAGE|ht.COPY_DST),u=_t(t,new Uint8Array(64),ht.UNIFORM|ht.COPY_DST),[d,f]=await Promise.all([Y(t,`grab WGSL`,gt,`beginFrame`),Y(t,`grab WGSL`,gt,`projectAnchors`)]),p=[{binding:0,resource:{buffer:a}},{binding:1,resource:{buffer:o}},{binding:2,resource:{buffer:s}},{binding:3,resource:{buffer:l}},{binding:4,resource:{buffer:c}},{binding:5,resource:{buffer:u}}],m=X(t,{cacheKey:d,layout:d.getBindGroupLayout(0),entries:p}),h=X(t,{cacheKey:f,layout:f.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}},{binding:3,resource:{buffer:l}},{binding:5,resource:{buffer:u}}]});return new e(t,n,r,i,l,u,d,f,m,h)}get active(){return this.state===`active`}begin(e,t,n){if(e.length!==this.vertexCount*4)throw Error(`GPU grab records do not match the packed vertex count`);this.device.queue.writeBuffer(this.recordsBuffer,0,e),this.bodyIndex=t,this.target=[...n],this.projectedTarget=[...n],this.grabOrigin=[...n],this.releaseVelocity=[0,0,0],this.releaseAfterInitialize=!1,this.state=`initialize`}updateTarget(e){this.state!==`active`&&this.state!==`initialize`||(this.target=[...e])}end(e){this.state!==`active`&&this.state!==`initialize`||(this.releaseVelocity=yt(e,this.maximumReleaseSpeed),this.state===`initialize`?this.releaseAfterInitialize=!0:this.state=`release`)}uploadParameters(e,t){let n=new ArrayBuffer(64),r=new Float32Array(n),i=new Uint32Array(n);r.set(t,0),r.set(this.target,4),r.set(e===3?this.grabOrigin:this.releaseVelocity,8),i[12]=e,i[13]=this.vertexCount,i[14]=this.bodyIndex,this.device.queue.writeBuffer(this.parametersBuffer,0,n)}encodeFrameStart(e){if(this.state===`inactive`)return;let t=this.state===`initialize`?3:this.state===`active`?1:2,n=t===3?this.grabOrigin:this.projectedTarget,r=t===1||t===3?vt(this.target,n,this.maximumFrameTranslation):[0,0,0];this.uploadParameters(t,r),(t===1||t===3)&&(this.projectedTarget=[n[0]+r[0],n[1]+r[1],n[2]+r[2]]);let i=e.beginComputePass();i.setPipeline(this.beginFramePipeline),i.setBindGroup(0,this.beginFrameGroup),i.dispatchWorkgroups(Math.ceil(this.vertexCount/64)),i.end(),t===2?this.state=`inactive`:t===3&&(this.state=`active`,this.releaseAfterInitialize&&(this.state=`release`))}encodeProjection(e){if(this.state!==`active`)return;let t=e.beginComputePass();t.setPipeline(this.projectPipeline),t.setBindGroup(0,this.projectGroup),t.dispatchWorkgroups(Math.ceil(this.vertexCount/64)),t.end()}destroy(){J(this.recordsBuffer),J(this.parametersBuffer)}},xt={COPY_SRC:4,COPY_DST:8,MAP_READ:1,STORAGE:128,UNIFORM:64},St=1,Ct=`
struct Params {
  origin: vec4<f32>,
  direction: vec4<f32>,
  triangleCount: u32,
...
`;function wt(e,t,n){return qe(e,t,n)}var Tt=class e{device;triangleCount;parametersBuffer;resultBuffer;readbackBuffer;clearPipeline;distancePipeline;trianglePipeline;clearGroup;distanceGroup;triangleGroup;constructor(e,t,n,r,i,a,o,s,c,l,u){this.device=e,this.triangleCount=t,this.parametersBuffer=n,this.resultBuffer=r,this.readbackBuffer=i,this.clearPipeline=a,this.distancePipeline=o,this.trianglePipeline=s,this.clearGroup=c,this.distanceGroup=l,this.triangleGroup=u}static async create(t,n,r,i){let[a,o,s]=await Promise.all([Y(t,`ray-pick WGSL`,Ct,`clearResult`),Y(t,`ray-pick WGSL`,Ct,`findDistance`),Y(t,`ray-pick WGSL`,Ct,`findTriangle`)]),c=wt(t,new Uint8Array(48),xt.UNIFORM|xt.COPY_DST),l=wt(t,new Uint32Array(2),xt.STORAGE|xt.COPY_SRC),u=t.createBuffer({size:8,usage:xt.MAP_READ|xt.COPY_DST}),d=[{binding:0,resource:{buffer:n}},{binding:1,resource:{buffer:r}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:c}}],f=X(t,{cacheKey:a,layout:a.getBindGroupLayout(0),entries:[{binding:2,resource:{buffer:l}}]}),p=X(t,{cacheKey:o,layout:o.getBindGroupLayout(0),entries:d}),m=X(t,{cacheKey:s,layout:s.getBindGroupLayout(0),entries:d});return new e(t,i,c,l,u,a,o,s,f,p,m)}async pick(e,t){let n=new ArrayBuffer(48),r=new Float32Array(n),i=new Uint32Array(n);r.set(e,0),r.set(t,4),i[8]=this.triangleCount,this.device.queue.writeBuffer(this.parametersBuffer,0,n);let a=this.device.createCommandEncoder(),o=a.beginComputePass();o.setPipeline(this.clearPipeline),o.setBindGroup(0,this.clearGroup),o.dispatchWorkgroups(1),o.end(),o=a.beginComputePass(),o.setPipeline(this.distancePipeline),o.setBindGroup(0,this.distanceGroup),o.dispatchWorkgroups(Math.ceil(this.triangleCount/64)),o.end(),o=a.beginComputePass(),o.setPipeline(this.trianglePipeline),o.setBindGroup(0,this.triangleGroup),o.dispatchWorkgroups(Math.ceil(this.triangleCount/64)),o.end(),a.copyBufferToBuffer(this.resultBuffer,0,this.readbackBuffer,0,8),this.device.queue.submit([a.finish()]),await this.readbackBuffer.mapAsync(St);let s=new Uint32Array(this.readbackBuffer.getMappedRange()).slice();return this.readbackBuffer.unmap(),s[1]===4294967295?null:{triangle:s[1],distance:new Float32Array(s.buffer,0,1)[0]}}destroy(){J(this.parametersBuffer),J(this.resultBuffer),this.readbackBuffer.destroy()}},Et=`
struct Globals {
  dt: f32,
  vertexCount: u32,
  gravity: f32,
...
fn projectStretchEdge(firstIndex: u32, secondIndex: u32, restLength: f32) {
  ...
  let maximumLength = restLength * ${Ee};
...
fn projectPlate(@builtin(global_invocation_id) id: vec3<u32>) {
  ...
  var position = positions[vertex];
  if (position.w <= 0.0) { return; }
  if (length(position.xz) > ${e}) { return; }
  let minimumY = plateHeight(position.x, position.z) + ${t};
  if (position.y >= minimumY) { return; }
  let previousPosition = previous[vertex];
  let previousMinimumY = plateHeight(previousPosition.x, previousPosition.z) + ${t};
...
fn projectCutSurface(@builtin(global_invocation_id) id: vec3<u32>) {
  ...
  for (var pairIndex = 0u; pairIndex < params.pairCount; pairIndex += 1u) {
    ...
    let negativeCorrection = -normal * (negative.w * lambda);
    let positiveCorrection = normal * (positive.w * lambda);
    negative = vec4<f32>(negative.xyz + negativeCorrection, negative.w);
    positive = vec4<f32>(positive.xyz + positiveCorrection, positive.w);
    positions[pair.indices.x] = negative;
    positions[pair.indices.y] = positive;

    // Opening a freshly duplicated seam is a topology repair, not a physical
    // impulse. Move the velocity reference by the same amount so the following
    // velocity update does not turn this positional correction into a launch.
    var previousNegative = previous[pair.indices.x];
    var previousPositive = previous[pair.indices.y];
    previousNegative = vec4<f32>(
      previousNegative.xyz + negativeCorrection,
      previousNegative.w,
    );
    previousPositive = vec4<f32>(
      previousPositive.xyz + positiveCorrection,
      previousPositive.w,
    );
    previous[pair.indices.x] = previousNegative;
    previous[pair.indices.y] = previousPositive;
  }
}
`,At=`
struct Globals {
